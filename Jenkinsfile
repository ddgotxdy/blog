pipeline {
    ...
    parameters {
        choice(
            name: 'project_name',
            choices: ['blog-gateway', 'blog-api', 'blog-article-service', 'blog-file-service', 'blog-search-service', 'blog-sms-service', 'blog-auth-service'],
            description: '项目名称'
        )
        choice(
            name: 'tag',
        ...
        choice(
            name: 'port',
            choices: ['28080', '28081', '28082', '28083', '28084', '28085', '28086'],
            description: '端口号'
        )
        choice(
            name: 'active',
